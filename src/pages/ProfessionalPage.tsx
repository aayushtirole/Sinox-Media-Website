...
export default function ProfessionalPage() {
  ...
  const planDetails = {
    ...
    price: "₹59,999 / $999",
    description: "For established businesses ready to scale their content strategy",
    features: [
      "25 videos per month",
      "4K quality",
      "Unlimited revisions",
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await createContactSubmission({
        ...
        message: `Professional Plan Inquiry: ${formData.message}`
      });
        ...
        <div className="container mx-auto px-4 xl:px-8">
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-12 xl:gap-16 items-start">
            ...
            <div className="space-y-8">
              <div>
                <Badge className="mb-4 bg-primary text-white shadow-glow">
              ...
              <Card className="p-8 gradient-border shadow-glow pulse-glow" style={{ borderRadius: "1.5rem" }}>
                <div className="mb-6">
              ...
              <Card className="p-6 bg-secondary/30 border-0" style={{ borderRadius: "1.5rem" }}>
                ...
                <ul className="space-y-2 text-muted-foreground">
                  <li>• Growing businesses scaling their content</li>
                  <li>• Brands with high-volume content needs</li>
                  <li>• Companies requiring strategic guidance</li>
                  <li>• Teams needing dedicated support</li>
                </ul>
              </Card>
              ...
              <Card className="p-6 bg-primary/5 border-primary/20" style={{ borderRadius: "1.5rem" }}>
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Get priority access to our creative team, faster turnaround times, and strategic content planning sessions to maximize your ROI.
                    </p>
                  </div>
                </div>
              </Card>
