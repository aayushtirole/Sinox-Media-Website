-- 00001_create_sinox_media_tables.sql
-- Sinox Media: idempotent migration (safe to run multiple times)
...
-- Portfolio Items (safe)
INSERT INTO portfolio_items (image_url, views, type, display_order)
VALUES
...
-- Testimonials (safe)
INSERT INTO testimonials (client_name, client_role, client_company, testimonial_text, rating, display_order)
VALUES
('Sarah Johnson', 'Marketing Director', 'TechFlow Inc',
 'Sinox Media transformed our brand presence with stunning content. Their attention to detail and creative vision exceeded our expectations.', 5, 1),
('Michael Chen', 'CEO', 'StartupHub',
 'Working with Sinox Media was a game-changer for our content strategy. Professional, creative, and always on time.', 5, 2),
('Emily Rodriguez', 'Brand Manager', 'Fashion Forward',
 'The quality of content produced by Sinox Media is unmatched. They truly understand how to tell a brand story.', 5, 3)
ON CONFLICT DO NOTHING;

-- Pricing Plans (safe)
INSERT INTO pricing_plans (plan_name, plan_description, price_inr, price_usd, features, is_popular, display_order)
VALUES
...
('What types of content do you produce?',
 'We specialize in short-form content including Instagram Reels, YouTube Shorts, TikTok videos, and promotional content. We also produce long-form videos, documentaries, and brand stories.',
 'Services', 1),
('How long does it take to produce a video?',
 'Turnaround time depends on your plan. Starter plan: 7 days, Professional: 3 days, Enterprise: same-day delivery for urgent projects.',
 'Process', 2),
('Do you offer revisions?',
 'Yes! Starter plan includes 2 revisions per video, while Professional and Enterprise plans include unlimited revisions until you are satisfied.',
 'Process', 3),
('Can I cancel my subscription anytime?',
 'Yes, you can cancel your subscription at any time. There are no long-term contracts or cancellation fees.',
 'Billing', 4),
('Do you provide content strategy consultation?',
 'Professional and Enterprise plans include content strategy consultation to help you maximize engagement and reach your target audience.',
 'Services', 5),
('What is your refund policy?',
 'We offer a 14-day money-back guarantee if you are not satisfied with our service. No questions asked.',
 'Billing', 6)
ON CONFLICT DO NOTHING;

-- Site Stats (fixed to avoid duplicate stat_key errors)
...
CREATE INDEX IF NOT EXISTS idx_pricing_display_order ON pricing_plans(display_order);
...
CREATE INDEX IF NOT EXISTS idx_stats_display_order ON site_stats(display_order);
